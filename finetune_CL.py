...
def cond_fn_sdg(model, x, node_mask, t, text, scale=5.0, text_mask=None, prior_network=None):
    with torch.no_grad():
...
if __name__ == '__main__':
    weights = torch.load("model_GCN/model_GCN_1111_fixed_full200_guidance_epoch20.pt", map_location='cuda:0')
    #weights = torch.load("model_GCN/model_GCN_1111_fixed_step0_guidance_epoch2000.pt", map_location='cuda:0')
    model.load_state_dict(weights, strict=False)
    for epoch in tqdm(range(50)):
        #date = '1111_fixed_step0'
        date = '1111_fixed_full200_epoch20'
